...
<div class="container-fluid">
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control ckeditor" id="deskripsi_produk" name="deskripsi_produk" rows="6" placeholder="Masukkan Deskripsi Produk"></textarea>
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control ckeditor" id="spesifikasi_produk" name="spesifikasi_produk" rows="6" placeholder="Masukkan Spesifikasi Produk"></textarea>
            <script type="text/javascript">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="harga_produk" name="harga_produk" placeholder="Masukkan Harga Produk">
        </div>
        <div class="mb-3">
